...
from sregym.conductor.problems.booking_consistency_colocation_hotel_reservation import BookingConsistencyColocationHotelReservation
...
class ProblemRegistry:
    def __init__(self):
        self.PROBLEM_REGISTRY = {
            ...
            "booking_consistency_colocation_hotel_reservation": lambda: BookingConsistencyColocationHotelReservation(),
